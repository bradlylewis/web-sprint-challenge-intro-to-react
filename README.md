...
React is a JavaScript library that was created by Facebook who incorporated componenets to solve the problem with User Interfaces; having to retype an abundance of code.

2. Describe component state.

The componenet state is where you store values that belong to the componenet which changes over time.

3. Describe props.

Similar to HTML, props - or properties - act as arguments when passing data down to a component.

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are when it effects something outside of the function being executed. You could set a useEffect to change a variable whenever the prop changes.
